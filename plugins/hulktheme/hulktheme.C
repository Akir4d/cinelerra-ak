...
char* HULKTHEMEMain::plugin_title()
{
	return "Hulk-theme";
}
...
{
	theme = new HULKTHEME;
	extern unsigned char _binary_hulktheme_data_start[];
	theme->set_data(_binary_hulktheme_data_start);
	return theme;
}
...
void HULKTHEME::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	mbuttons_x = 0;
...
void HULKTHEME::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
SET_TRACE
...
void HULKTHEME::get_recordgui_sizes(RecordGUI *gui, int w, int h)
{
	
}

void HULKTHEME::get_rmonitor_sizes(int do_audio, 
	int do_video,
	int do_channel,
	int do_interlace,
	int do_avc,
...
void HULKTHEME::get_vwindow_sizes(VWindowGUI *gui)
{
	vmeter_y = 5;
...
void HULKTHEME::get_preferences_sizes()
{
}
...
void HULKTHEME::get_new_sizes(NewWindow *gui)
{
}
...
void HULKTHEME::get_plugindialog_sizes()
{
	int x = 10, y = 30;
