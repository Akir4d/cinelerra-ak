...
THFUNCMain::THFUNCMain(PluginServer *server)
 : PluginTClient(server)
{
}

THFUNCMain::~THFUNCMain()
{
}

char* THFUNCMain::plugin_title()
{
	return "THEMENAME";
}

Theme* THFUNCMain::new_theme()
{
	theme = new THFUNC;
	extern unsigned char _binary_THEME_data_start[];
	theme->set_data(_binary_THEME_data_start);
	return theme;
}
...
void THFUNC::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	mbuttons_x = 0;
...
void THFUNC::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
SET_TRACE
...
void THFUNC::get_recordgui_sizes(RecordGUI *gui, int w, int h)
{
	
}

void THFUNC::get_rmonitor_sizes(int do_audio, 
	int do_video,
	int do_channel,
	int do_interlace,
	int do_avc,
...
void THFUNC::get_vwindow_sizes(VWindowGUI *gui)
{
	vmeter_y = 5;
...
void THFUNC::draw_rwindow_bg(RecordGUI *gui)
{
// 	int y;
// 	int margin = 50;
// 	int margin2 = 80;
...
void THFUNC::draw_rmonitor_bg(RecordMonitorGUI *gui)
{
// 	int margin = 45;
// 	int panel_w = 300;
...
void THFUNC::draw_mwindow_bg(MWindowGUI *gui)
{
// Button bar
...
void THFUNC::draw_cwindow_bg(CWindowGUI *gui)
{
...
void THFUNC::draw_vwindow_bg(VWindowGUI *gui)
{
...
void THFUNC::get_preferences_sizes()
{
}


void THFUNC::draw_preferences_bg(PreferencesWindow *gui)
{
	gui->draw_vframe(get_image("preferences_bg"), 0, 0);
}

void THFUNC::get_new_sizes(NewWindow *gui)
{
}

void THFUNC::draw_new_bg(NewWindow *gui)
{
	gui->draw_vframe(get_image("new_bg"), 0, 0);
}

void THFUNC::draw_setformat_bg(SetFormatWindow *gui)
{
	gui->draw_vframe(get_image("setformat_bg"), 0, 0);
}


void THFUNC::get_plugindialog_sizes()
{
	int x = 10, y = 30;
