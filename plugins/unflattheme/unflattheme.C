...
char* UNFLATTHEMEMain::plugin_title()
{
	return "UnFlat Theme";
}
...
Theme* UNFLATTHEMEMain::new_theme()
{
	...
	extern unsigned char _binary_unflattheme_data_start[];
	theme->set_data(_binary_unflattheme_data_start);
	return theme;
}
...
void UNFLATTHEME::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	mbuttons_x = 0;
...
void UNFLATTHEME::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
SET_TRACE
...
void UNFLATTHEME::get_recordgui_sizes(RecordGUI *gui, int w, int h)
{
	
}

void UNFLATTHEME::get_rmonitor_sizes(int do_audio, 
	int do_video,
	int do_channel,
	int do_interlace,
	int do_avc,
...
void UNFLATTHEME::get_vwindow_sizes(VWindowGUI *gui)
{
	vmeter_y = 5;
...
void UNFLATTHEME::get_preferences_sizes()
{
}
...
void UNFLATTHEME::get_new_sizes(NewWindow *gui)
{
}
...
void UNFLATTHEME::get_plugindialog_sizes()
{
	int x = 10, y = 30;
